...
const DashboardNav = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-white w-full">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed sm:relative top-0 left-0 w-64 sm:w-2/12 bg-gray-800 p-5 flex flex-col gap-5 shadow-xl min-h-screen transition-transform duration-300 transform ${
