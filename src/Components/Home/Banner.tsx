  ...
  return (
    <div>
      <div className="bg-black">
        <div className="flex overflow-hidden space-x-0 text-nowrap text-xl xl:text-2xl font-bold uppercase py-5 text-[#E3962B]">
        ...
        <div className="w-full h-full ">
          <div className="flex justify-start items-end w-full h-full">
            <div className="px-5 lg:px-20 text-center lg:text-left font-bold">
